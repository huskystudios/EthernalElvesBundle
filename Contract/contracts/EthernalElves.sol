...
//STATE
    ...
    //////////NOTE MOVE THESE UP BEFORE DEPLOYMENT... had to do this cause of storage colission
       ...
       maxSupply            = 6666; //6666 for live
       INIT_SUPPLY          = 3300; //3300 for live
       initialized          = true;
       //isWlOpen             = true;
       price                = .088 ether;  //CHANGE to .088!!
       _remaining           = [220,660,2500]; //[200, 600, 2500]; //this is the supply of each whitelist role
