...
contract ElfCampaigns is Ownable{
...
function initialize(address _elfcontract) public onlyOwner {
...
function addCamp(uint256 id, uint16 baseRewards_, uint16 creatureCount_, uint16 expPoints_, uint16 creatureHealth_, uint16 minLevel_) external onlyOwner     
    {
