...
const Explore = ({ consoleOpen, setAlert, nftData, owner, clicked, selectAll, toggle, chain, toggleChain, setVisualMode, visualMode, reloadData, setReloadData, polyBalance }) => {
